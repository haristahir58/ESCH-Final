        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              <TableCell className="tableCell" style={{display:'flex'}}>Operations</TableCell>
            </TableRow>
          </TableHead>
         ...
         products.map((item, index) => (
            ...
            <Link to={`/admin/products/${item._id}`} className="buttonLink">Update</Link>
            <Link to={`/admin/products/${item._id}/details`} className="detailLink">Details</Link>
